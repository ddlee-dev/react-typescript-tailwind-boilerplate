...
// const isImgFile = (value?: string) => {
//   if (value) {
//     const extension = getFileExtension(value)?.toLowerCase() || '';
//     const supportedImageExtensions = ['jpeg', 'jpg', 'png'];
//     return supportedImageExtensions.includes(extension);
//   }
//   return false;
// };

// const updateImgPath = (filePath: string) => {
//   const isImage = isImgFile(filePath);
//   if (isImage) {
//     const fullImagePath = publicPath(filePath);
